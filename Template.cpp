...
//vector<vector<long long>> map1 = vector<vector<long long>>(n, vector<long long>(n)); //it is of type long long
//vector<vector<long long>> map2 = vector<vector<long long>>(n, vector<long long>(n, 0)); // all values are set to 0
VVL map1 = VVL(n, VL(n));
VVL map2 = VVL(n, VL(n, 0));
void multiplyNdMatrix(VVL &mat1, VVL &mat2) //matrix multi and vector call by refernce
{
